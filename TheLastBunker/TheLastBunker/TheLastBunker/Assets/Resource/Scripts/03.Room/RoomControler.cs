...
public class RoomControler : MonoBehaviour
{
    ...
    public void StageCreate()
    {
        ...
        {
            if(RoomData.Instance.RoomInformation[i].StageNum == PlayInformation.Instance.StageNum)
            {
                //CreateRoom(RoomData.Instance.RoomInformation[i].RoomNumX, RoomData.Instance.RoomInformation[i].RoomNumZ, RoomData.Instance.RoomInformation[i].RoomTiles, RoomData.Instance.RoomInformation[i].DoorTiles, RoomData.Instance.RoomInformation[i].EnermyRespown, RoomData.Instance.RoomInformation[i].ObjectPosition, RoomData.Instance.RoomInformation[i].roommoveterm);
            ...
            for (int x = 0; x < 20; x++)
            {
                if (DoorInformation[p] == red)
                {
                    if (x == 0)
                    {
                        ...
                        NewDoor.transform.position = new Vector3(roominformation.RoomNumX * 200, 35 + (roominformation.RoomNumY * 100), 0);
                    ...
                    else if (x == 19)
                    {
                        ...
                        NewDoor.gameObject.SetActive(true);
                        NewDoor.transform.position = new Vector3(190 + (roominformation.RoomNumX * 200), 35 + (roominformation.RoomNumY * 100), 0);
                        NewDoor.transform.localScale = new Vector3(10, 20);
                        NewDoor.gameObject.transform.parent = newarea.transform;
                        NewDoor.ControlerRoom = newarea.GetComponent<Room>();
