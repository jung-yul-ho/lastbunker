...
public class PlayerControl : MonoBehaviour
{
    ...
    public Button ModChange;
    public Button Interaction;

    //모드 스프라이트
    public Sprite Mod_Power;
    public Sprite Mod_Speed;
    public Sprite ActiveLaserRabber;
    public Sprite NoActiveLaserRabber;
    public Sprite ActiveRoomRabber;
    public Sprite NoActiveRoomRabber;
    public Sprite ActiveSecretRabber;
    public Sprite NoActiveSecretRabber;
    public Sprite UpdoorOpenSprite;
    public Sprite UpdoorClseSprite;
    public Sprite DowndoorOpenSprite;
    public Sprite DowndoorClosesSprite;
    public Sprite LeftdoorOpenSprite;
    public Sprite LeftdoorCloseSprite;
    public Sprite RightdoorOpenSprite;
    public Sprite RightdoorCloseSprite;

    public Sprite interactionOnSprite;
    public Sprite interactionOffSprite;
    ...
    public void PlayerModChange()
    {
        if(PlayInformation.Instance.GameOver == false)
        {
            ...
            {
                ModChange.GetComponent<Image>().sprite = Mod_Speed;
                Player.Instance.playermod = PlayerMod.MOD_SPEED;
            }
            else
            {
                ModChange.GetComponent<Image>().sprite = Mod_Power;
    ...
    public void Activeinteraction()
    {
        if (TargetObj != null)
        {
            ...
            TargetObj = null;
            Interaction.gameObject.GetComponent<Image>().sprite = interactionOffSprite;
        }
