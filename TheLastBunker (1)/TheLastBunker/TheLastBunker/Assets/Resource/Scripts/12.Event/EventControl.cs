...
public class EventControl : MonoBehaviour
{
    ...
    public void StartEvent(int EventNum)
    {
        ...
        if(eventstep[EventNum].ImageView == true)
        {
            DownMessageBox.Instance.BoxImage.gameObject.SetActive(false);
            PlayerControl.Instance.ClueImage.gameObject.SetActive(true);
            PlayerControl.Instance.ClueImage.sprite = eventstep[eventNum].ViewSprite;
        }
